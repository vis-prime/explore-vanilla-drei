...
async function setupMTM() {
  ...
  gui.add(generalParams, "renderEachMesh")
  ...
  const fboBack = new THREE.WebGLRenderTarget(1024, 1024, {
    minFilter: THREE.LinearFilter,
    magFilter: THREE.LinearFilter,
    encoding: renderer.outputEncoding,
    type: THREE.HalfFloatType,
  })
  const fboMain = new THREE.WebGLRenderTarget(1024, 1024, {
    minFilter: THREE.LinearFilter,
    magFilter: THREE.LinearFilter,
    encoding: renderer.outputEncoding,
    type: THREE.HalfFloatType,
  ...
  useFrame = () => {
    ...
    if (generalParams.renderEachMesh) {
...
function addPhysicalGui(gui, mat) {
  ...
  fol.add(mat, "attenuationDistance", 0, 1)
  fol.add(mat, "roughness", 0, 1)
  fol.add(mat, "clearcoat", 0, 1)
