import{S as De,O as Te}from"./OrbitControls-FqkbUa6U.js";import{T as Se}from"./TransformControls-DIS8GcSd.js";import{M as ne,O as ie,I as Ce,J as $,i as be,H as se,L as A,u as Fe,K as le,G as ce,b as de,Q as Re,d as _e,X as ze,Y as We,Z as Ie,C as ue,s as v,z as Be,_ as R,$ as Oe,F as je,a0 as Ee,a1 as Le,a2 as Ae,a3 as Ve,a4 as ke,k as Ne,W as Ge,V as He,S as Ue,A as Qe,a as Xe,c as Ye,R as qe}from"./three.module-CpOMtsua.js";import{M as N,a as Je}from"./MODEL_LIST-C-sQ1-VY.js";import{B as Ke}from"./BG_ENV-DSI1sdw8.js";import{u as Ze}from"./tween.esm-DFB-vPb4.js";import{E as $e,R as et,a as tt,B as at}from"./index-BasKPrgC.js";import{L as rt}from"./LoadingHelper-Bpwvv_dV.js";import{s as me}from"./shaderMaterial-BSjRKRz3.js";import"./EXRLoader-DkJrvfaI.js";import"./HDRLoader-CNYvXwJL.js";import"./GroundProjectedSkybox-DU_m07Wz.js";import"./HDRI_LIST-DJCqOZOR.js";const ot=new ie(-1,1,1,-1,0,1);class nt extends Ce{constructor(){super(),this.setAttribute("position",new $([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new $([0,2,0,0,2,0],2))}}const it=new nt;class st{constructor(t){this._mesh=new ne(it,t)}dispose(){this._mesh.geometry.dispose()}render(t){t.render(this._mesh,ot)}get material(){return this._mesh.material}set material(t){this._mesh.material=t}}function G(e=1024,t=1024,s){var a=e,S=t,_=s||{};const{samples:y=0,depth:C,...z}=_,B=C??_.depthBuffer;var m=new be(a,S,{minFilter:A,magFilter:A,type:se,...z});return B&&(m.depthTexture=new Fe(a,S,le)),m.samples=y,m}const lt=e=>e?.isVector3;function ee(e=je){const t={value:new R};return Object.assign(new ke({side:e}),{viewMatrix:t,onBeforeCompile:s=>{s.uniforms.viewMatrix=t,s.fragmentShader=`vec3 inverseTransformDirection( in vec3 dir, in mat4 matrix ) {
