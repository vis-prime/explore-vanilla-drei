import{m as f,W as x,S as b,A as z,a as B,b as G,G as P,D as F,n as M,c as T,o as u,T as A,R as y,C as L}from"./three.module-mb-WANHP.js";import{S as k,O as U,G as W,D as H}from"./OrbitControls-BThPDOU9.js";import{E as $}from"./EXRLoader-CrxFBtHm.js";import{T as j}from"./TransformControls-i8oTrZWj.js";import{T as q,G as Y,E as X}from"./tween.esm-DFB-vPb4.js";import{M as Z}from"./MODEL_LIST-CtQt_fBO.js";function Q(o,t,e){t.traverse(n=>{n.material&&(Array.isArray(n.material)?n.material.forEach(s=>{o.properties.remove(s),s.dispose()}):(o.properties.remove(n.material),n.material.dispose()))}),o.info.programs.length=0,o.compile(t,e)}const V=({focus:o=0,size:t=25,samples:e=10}={})=>{const n=f.shadowmap_pars_fragment;return f.shadowmap_pars_fragment=f.shadowmap_pars_fragment.replace("#ifdef USE_SHADOWMAP",`#ifdef USE_SHADOWMAP
