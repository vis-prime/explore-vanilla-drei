import{m as f,W as x,S as b,A as z,P,a as B,G,D as F,n as M,c as T,o as u,T as A,R as y,C as L}from"./three.module-B7XIeoLg.js";import{S as k,O as U,G as W,D as H}from"./OrbitControls-DgKsolBe.js";import{E as $}from"./EXRLoader-BPNILuzU.js";import{T as j}from"./TransformControls-BrSW2VXC.js";import{T as q,G as Y,E as X}from"./tween.esm-BunxfTqY.js";import{M as Z}from"./MODEL_LIST-Dp8f6OQf.js";function Q(o,t,e){t.traverse(n=>{n.material&&(Array.isArray(n.material)?n.material.forEach(s=>{o.properties.remove(s),s.dispose()}):(o.properties.remove(n.material),n.material.dispose()))}),o.info.programs.length=0,o.compile(t,e)}const V=({focus:o=0,size:t=25,samples:e=10}={})=>{const n=f.shadowmap_pars_fragment;return f.shadowmap_pars_fragment=f.shadowmap_pars_fragment.replace("#ifdef USE_SHADOWMAP",`#ifdef USE_SHADOWMAP
